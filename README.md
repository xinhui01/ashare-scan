...
历史日线现已支持多源切换，可在 `auto / eastmoney / sina / netease / baidu / sohu / ths / wscn` 之间切换。
...
- 历史数据源支持 `auto / eastmoney / sina / netease / baidu / sohu / ths / wscn`；`auto` 会优先东财，失败后切换到其它带成交额的完整历史源
