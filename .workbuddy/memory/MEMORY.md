...
## 退潮深化期纪律（0805~0808 连续验证）
- 情绪/涨停/晋级率三者连续三天同步回落（85/102/22.9% → 63/84/12.9% → 53/74/9.5%）= 退潮深化 regime
- **"指数涨+情绪跌"分歧信号**（0807: 上证+1.02% 但情绪53/涨停74/晋级率9.5%）= 大票撑指数题材退潮，超短最差环境
- 退潮深化期：总仓从严 ≤2成（非平时5成），无主线无观察标的时空仓等
- **主线一天可崩**：0806 计算机通信电子主线20只 → 0807 直接0只，追主线=追高被套
- 广和通闭环验证（0806→0807）：竞价条件（高开+量比>3+买盘）三条全不满足 → 正确未入场；退潮期追强势股风险极大
- 前排高分≠可做：0807 前排5只(92~104分)全有硬伤（4只亏损+2只主力大幅流出+1只反包池）
